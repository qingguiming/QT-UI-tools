#ifndef OAUDIOWAVEWIDGET_H
#define OAUDIOWAVEWIDGET_H
...
class QDESIGNER_WIDGET_EXPORT OAudioWaveWidget : public QWidget
{
    Q_OBJECT
    Q_ENUMS(WaveStyle)
...
public:
    ...
    explicit OAudioWaveWidget(QWidget *parent = 0);
