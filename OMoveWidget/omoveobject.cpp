...
OMoveObject::OMoveObject(QObject *parent) : QObject(parent)
{
...
bool OMoveObject::eventFilter(QObject *watched, QEvent *event)
{
    if (widget != 0 && watched == (QObject *)widget)
    {
...
void OMoveObject::setWidget(QWidget *widget)
{
    if (this->widget == 0) {
        this->widget = widget;
...
void OMoveObject::setLeftButton(bool leftButton)
{
