#ifndef OIMAGEANIMATION_H
#define OIMAGEANIMATION_H
...
class QDESIGNER_WIDGET_EXPORT OImageAnimation : public QWidget
{
    Q_OBJECT
...
public:
    ...
    explicit OImageAnimation(QWidget *parent = 0);
...
private slots:
    void factorUpdate(const QVariant &value);
