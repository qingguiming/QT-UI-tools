...
class QDESIGNER_WIDGET_EXPORT OGaugeEdit : public QWidget
{
    Q_OBJECT
...
public:
    explicit OGaugeEdit(QWidget *parent = 0);
    ~OGaugeEdit();
...
private:
    ...
    int startAngle;                 //开始旋转角度 以6点钟方向为0，顺时针增加、0~360
    int endAngle;                   //结束旋转角度 以6点钟方向为0，顺时针增加、0~360
