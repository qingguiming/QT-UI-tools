#ifndef OTIMEAXISWIDGET_H
#define OTIMEAXISWIDGET_H
...
class QDESIGNER_WIDGET_EXPORT OTimeAxisWidget : public QScrollArea
{
    Q_OBJECT
...
public:
    explicit OTimeAxisWidget(QWidget *parent = 0);
