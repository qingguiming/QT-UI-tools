#ifndef OGAUGESPEED_H
#define OGAUGESPEED_H
...
class QDESIGNER_WIDGET_EXPORT OGaugeSpeed : public QWidget
{
    Q_OBJECT
...
public:
    explicit OGaugeSpeed(QWidget *parent = 0);
...
private:
    ...
    int startAngle;                 //开始旋转角度 以6点钟为0，顺时针增大
    int endAngle;                   //结束旋转角度 以6点钟为0，顺时针增大
